...
// USING A POWERSHELL SCRIPT WITH DEPLOYMENT SCRIPT, DOWNLOAD APPLICATION SETTING FILE FROM THE WEB AND SAVE CONTENT TO STAGE IN THE BLOB STORAGE FOR AN APPLICATION TO READ
